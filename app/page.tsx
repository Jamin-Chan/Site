      ...
      <div className="grid grid-cols-1 place-items-center h-fit">
        ...
        <div className="grid grid-cols-3 gap-10 w-11/12 h-min text-black text-wrap">
          <div className="rounded-lg bg-gradient-to-r from-pink-600 via-pink-500 to-fuchsia-500">
            ...
            <ul className="flex justify-center flex-wrap text-xl mt-4 *:p-1 *:m-1 *:bg-white *:rounded-md *:border-2 *:border-black *:border-solid hover:*:border-amber-500">
              <li>AP Calculus</li>
              <li>AP Chemistry</li>
              <li>AP Statistics</li>
        ...
        <div className="grid grid-cols-1 place-items-center h-fit pt-32">
            <p className="text-6xl font-semibold">
              Experience
            </p>
        </div>
